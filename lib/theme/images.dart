class Images {
  ...
  static String teachers = "assets/logo/teacher.jpg";
  static String events = "assets/logo/event.jpg";
  static String cameraman = "assets/logo/eventbooking.png";
  static String cheographys = "assets/logo/dancer.jpg";
  static String hireme = "assets/logo/company logo.jpg";
